...
set extName=gamepad_force_focus
set dllName=gamepad_force_focus
set gmlDir14=%solutionDir%gamepad_force_focus.gmx
set gmlDir22=%solutionDir%gamepad_force_focus_yy
set gmlDir23=%solutionDir%gamepad_force_focus_23
